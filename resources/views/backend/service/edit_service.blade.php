                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select name="subcategory_id" id="select" class="form-control">
                                            ...
                                            <option value="{{ $sub->id }}" {{ ($sub->id==$service->subcategory_id)? 'selected' : '' }}>{{ $sub->subcategory_name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select name="subsubcategory_id" id="select" class="form-control">
                                            ...
                                            <option value="{{ $subsub->id }}" {{ ($subsub->id==$service->subsubcategory_id)? 'selected' : '' }}>{{ $subsub->subsubcategory_name }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <img src="{{ URL::to($service->image) }}" id="mainThmb" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="row"> <!-- start 7th row -->
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="description" id="editor1" class="form-control" placeholder="Description">{!! htmlspecialchars_decode($service->description) !!}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end 7th row -->
