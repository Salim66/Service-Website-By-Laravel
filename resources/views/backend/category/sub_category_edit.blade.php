                   ...
                   <div class="table-responsive">
                        <form action="{{ route('subcategory.update', $data->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="subcategory_name_en" class="form-control" value="{{ $data->subcategory_name_en }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="subcategory_name_ar" class="form-control" value="{{ $data->subcategory_name_ar }}">
